package at.course_service.config;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                .authorizeHttpRequests(customizer -> customizer
                        ...
                        .requestMatchers(HttpMethod.POST, "/v1/courses/course-info").permitAll()
                        .requestMatchers("/actuator/**").permitAll()
                        .requestMatchers(HttpMethod.POST, "/v1/courses/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/v1/courses/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PATCH, "/v1/courses/**").hasRole("ADMIN")
